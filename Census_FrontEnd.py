...
def table1():
    ...
    def c1():
        tuser = Label(root,text="Enter user : ").pack(side= LEFT)
        ent1 = Entry(root).pack(side= RIGHT)
        tpassword = Label(root,text="Enter password : ").pack(side= LEFT)
        ent2 = Entry(root).pack(side= RIGHT)
        mydb = mysql.connector.connect(host="localhost",user=tuser,passwd=tpassword)
        mycursor = mydb.cursor()
        tdb = Label(root,text="Database name : ").pack(side= LEFT)
    ...
    def c2():
        ...
        tdb = Label(root,text="Database name : ").pack(side= LEFT)
        ent3 = Entry(root).pack(side= RIGHT)
        test1 = Label(root,text="TEST").pack(side= BOTTOM)
        btn4 = Button(root,text="Click Me",command=table2).pack(side=BOTTOM)

    def c3():
        exit()


    btnc1 = Button(root,text="Automatic Configuration (An Automatic Configuration from Scratch.)",command = c1).pack()
    
    btnc2 = Button(root,text="Manual Configuration (For Pre-Made Database Only,You can setup table later on in pre-made database.)",command = c2).pack()
    
    btnc3 = Button(root,text="Exit Program",command = c3).pack()
    



btn1 = Button(root,text="Click me to Start Setup",command = table1).pack()
...
def table2():
    Tlabel = Label(text="Main Menu : ",bg="#FFE5B4",font=("Arial Rounded MT Bold",56,"bold")).pack()
    button1 = Button(text="Show Database Records.",command=lcensus,activebackground="#800080",bd=2,width=40,height=2,font=(32)).pack()
    button2 = Button(text="Add A New Record in Database.",command=icensus,activebackground="#800080",bd=2,width=40,height=2,font=(32)).pack()
    button3 = Button(text="Update A Record in Database.",command=ucensus,activebackground="#800080",bd=2,width=40,height=2,font=(32)).pack()
    button4 = Button(text="Delete A Record from Database.",command=dcensus,activebackground="#800080",bd=2,width=40,height=2,font=(32)).pack()
    button5 = Button(text="Search for A Record in Database.",command=scensus,activebackground="#800080",bd=2,width=40,height=2,font=(32)).pack()
    button6 = Button(text="Import Data from CSV.",command=rcensus,activebackground="#800080",bd=2,width=40,height=2,font=(32)).pack()
    button7 = Button(text="Export Records from Database to CSV.",command=wcensus,activebackground="#800080",bd=2,width=40,height=2,font=(32)).pack()
    button8 = Button(text="Setup Table(from premade database only.).",command=setupcensus,activebackground="#800080",bd=2,width=40,height=2,font=(32)).pack()
    button9 = Button(text="Quit Program.",command=quit,activebackground="#800080",bd=2,width=40,height=2,font=(32)).pack()
